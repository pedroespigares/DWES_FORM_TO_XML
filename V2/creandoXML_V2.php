<html>
 ...
 <body>
  ...
  <form action="creaXML_V2.php" method="POST" id="formulario">
	<label>Código:</label>
	...
	<input type="radio" name="tipo" value="obligatorio"/>Obligatoria
	<input type="radio" name="tipo" value="optativo"/>Optativa<br />
